...
export const PROJECTS: Project[] = [
  {
    ...
    serviceId: 'structural-strengthening',
  ...
  },
  {
    ...
    name: 'Curtain Wall Waterproofing & Defect Rectification — Enfield',
    location: 'Enfield, NSW',
    date: '2025',
    serviceType: 'Curtain Wall Waterproofing Injection',
    serviceId: 'curtain-wall-injection',
    category: ['Commercial', 'Waterproofing', 'Defect Rectification'],
    ...
    tagline: 'Curtain wall injection eliminating persistent basement water ingress through brick masonry in an occupied strata commercial building',
    challenge: 'The basement level carpark of a commercial development at 194 Liverpool Road, Enfield, was experiencing persistent water ingress through its perimeter brick walls. Moisture was penetrating the brick masonry and entering the underground carpark, with concrete cracking contributing further to the water problem. Left untreated, it causes progressive deterioration of structural concrete elements and ongoing liability. With the building occupied and strata established, the developer needed an effective, precise, and minimally disruptive solution. Brick masonry is notoriously difficult to waterproof using conventional surface-applied systems — without the right diagnosis, costly trial-and-error repairs were the likely outcome.',
    solution: 'TRD Remedial began with a thorough site inspection and condition assessment of the affected basement walls. Detailed crack mapping was carried out across the perimeter to identify all active water ingress points and the pattern of moisture movement. The investigation identified curtain wall waterproofing injection as the most effective system. Hydrophobic epoxy resin was injected under controlled pressure into and behind the brick wall, creating a flexible, water-repelling barrier conforming to the masonry\'s internal voids and crack network. Unlike surface-applied membranes, this approach addresses the source from within the wall. Car park bays were temporarily blocked to complete all works in a single mobilisation.',
    results: 'Water ingress was fully arrested upon completion of the curtain wall injection system. The developer\'s warranty defect was formally closed within four weeks of TRD Remedial\'s initial engagement — from first inspection to final result. By identifying the correct system and executing it precisely on the first attempt, the developer avoided the significant cost and disruption of repeated failed repairs. The treatment protects the building\'s structural concrete elements from ongoing moisture damage that would have continued unchecked, preventing far more costly remediation in the future. The entire scope was completed in a single mobilisation with minimal disruption.',
    stats: [
      { value: '4wk', label: 'Investigation to Completion' },
      { value: '100%', label: 'Water Ingress Stopped' },
      { value: '1', label: 'Mobilisation Required' },
    ],
    galleryImages: [
      {
    ...
    timeline: '4 Weeks (investigation, reporting & remediation)',
    relatedProjects: ['project-001', 'project-011'],
    metaTitle: 'Curtain Wall Waterproofing Injection — Enfield Commercial Building NSW | TRD Remedial',
    metaDescription: 'TRD Remedial eliminated persistent basement water ingress through brick masonry at an Enfield commercial building using curtain wall hydrophobic epoxy injection — warranty defect closed in four weeks.',
  },
  {
    id: 'project-004',
  ...
  },
  {
    ...
    name: 'Structural Wall Repairs & Building Commissioner Compliance — Northbridge',
    location: 'Northbridge, NSW',
    date: '2025',
    serviceType: 'Structural Crack Repair & Compliance',
    serviceId: 'structural-alterations',
    category: ['Residential', 'Structural', 'Compliance'],
    ...
    tagline: 'Fire stair wall repair across four levels with full NSW Building Commissioner compliance achieved in five days',
    challenge: 'A reinforced concrete fire stair wall across four levels of an occupied residential building in Northbridge was displaying structural defects: visible cracking, localised wall movement and bowing, and concrete spalling with delamination. The defects were attributed to poor workmanship during original construction and subsequent settlement. The NSW Building Commissioner\'s office had issued a formal rectification order requiring the defects to be addressed and compliance demonstrated. For an occupied building, this created significant time pressure — failure to respond adequately risked further regulatory escalation and potential enforcement action.',
    solution: 'TRD Remedial was engaged to develop and deliver the repair methodology across all four levels. The team assessed the full extent of defects, proposed a comprehensive repair scope, and coordinated with the structural engineer to satisfy the rectification order. The full repair program was executed in five days and included epoxy crack injection to stabilise and seal structural cracks, concrete spalling repairs to restore section integrity, reprofiling and rendering to reinstate wall surfaces, and concrete cutting with localised demolition and reinstatement where structural defects required full section repair.',
    results: 'The full repair scope was completed within five days. Structural cracking was stabilised, all affected wall sections reinstated, and the building returned to compliance. The rectification order issued by the NSW Building Commissioner\'s office was formally closed — preventing any further regulatory escalation and protecting the developer and residents from the consequences of unresolved structural defects. All works were managed with minimal disruption to residents across all four levels of the occupied building.',
    stats: [
      { value: '4', label: 'Levels Repaired' },
      { value: '5', label: 'Days to Complete' },
      { value: 'Closed', label: 'Commissioner Order' },
    ],
    galleryImages: [
      {
    ...
    metaTitle: 'Structural Wall Repairs & Building Commissioner Compliance — Northbridge NSW | TRD Remedial',
    metaDescription: 'TRD Remedial repaired a reinforced concrete fire stair wall across four levels of an occupied Northbridge residential building in five days, closing a NSW Building Commissioner rectification order.',
  },
  {
    id: 'project-006',
    slug: 'rouse-hill-slab-scanning',
    name: 'Post-Tensioned Slab Scanning & Controlled Penetration — Rouse Hill',
    location: 'Rouse Hill, NSW',
    date: '2025',
    serviceType: 'Slab Scanning & Post-Tensioned Concrete',
    serviceId: 'slab-scanning',
    category: ['Commercial', 'Diagnostic', 'Construction'],
    ...
    tagline: 'GPRS scanning and controlled tendon truncation enabling safe penetrations through 500mm post-tensioned slabs across three levels',
    challenge: 'During fitout of a multi-level construction project at 25 Macquarie Road, Rouse Hill, a critical oversight was identified: a 2m x 1.5m penetration required for essential building services had been missed across three levels of a 500mm thick post-tensioned slab. Post-tensioned slabs carry steel tendons under extreme tension — cutting through an active PT tendon without prior investigation risks a sudden, catastrophic release of energy, a life-threatening hazard for any worker in the zone. Beyond immediate safety risk, an uncontrolled cut could seriously compromise the structural integrity of the slab system across multiple floors. The structural engineer needed exact tendon and reinforcement positions before any concrete could be cut.',
    solution: 'TRD Remedial mobilised with GPRS (Ground Penetrating Radar) scanning technology to precisely map the post-tension tendons and reinforcement within the slab across all three levels. Detailed scan reports were produced and coordinated directly with the structural engineer to confirm penetration locations and identify conflicting tendons. Where tendons intersected with the proposed openings, the team carried out a controlled, engineer-directed process: carefully exposing affected tendons, professionally truncating them to safely relieve tension, and verifying the work before any concrete cutting commenced. Once preparation was complete and approved, all required penetrations were cut and formed across three levels.',
    results: 'All three penetrations were successfully introduced within one week, on time and without incident. By engaging TRD Remedial to scan, investigate, and manage the controlled tendon truncation, the builder avoided a potentially life-threatening PT tendon strike and a serious structural failure in a building under active construction. Critical services were installed as per the original approved design, allowing the project to move forward. The work preserved the structural integrity of the post-tensioned slab system across all three levels and kept the construction program on track.',
    stats: [
      { value: '3', label: 'Levels Scanned & Cut' },
      { value: '500mm', label: 'PT Slab Thickness' },
      { value: '1wk', label: 'Completed In' },
    ],
    galleryImages: [
      {
      ...
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-08.jpg', alt: 'Post-tension cable truncation pocket with exposed cables' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-09.jpg', alt: 'Exposed post-tension cables during truncation process' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-10.jpg', alt: 'Multiple truncation trenches with exposed cables and tools' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-11.jpg', alt: 'Wide view of truncation work area with safety equipment' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-12.jpg', alt: 'Post-tension cable identification and exposure' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-13.jpg', alt: 'Temperature monitoring during grout curing' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-14.jpg', alt: 'Completed grout fill pattern across intersecting trenches' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-15.jpg', alt: 'Completed T-junction grout fills with smooth finish' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-16.jpg', alt: 'Finished grout restoration of truncation pockets' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-17.jpg', alt: 'Aerial view of exposed post-tension cable bundle' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-18.jpg', alt: 'Core-drilled opening for slab access' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-19.jpg', alt: 'Rectangular core-drilled opening with scalloped edges' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-20.jpg', alt: 'Precision core drilling perimeter for slab opening' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-21.jpg', alt: 'Completed core-drilled rectangular opening top view' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-22.jpg', alt: 'Final core drill pattern from elevated angle' },
      { url: '/images/projects/rouse-hill-slab-scanning/gallery-23.jpg', alt: 'Core drilling equipment in operation at slab edge' },
    ],
    timeline: '1 Week',
    relatedProjects: ['project-004', 'project-007'],
    metaTitle: 'Post-Tensioned Slab Scanning & Controlled Penetration — Rouse Hill NSW | TRD Remedial',
    metaDescription: 'TRD Remedial delivered GPRS scanning and controlled tendon truncation across three levels of 500mm post-tensioned slab at Rouse Hill, enabling safe penetrations in one week with zero incidents.',
  },
  {
    id: 'project-007',
    slug: 'pelican-road-schofields',
    name: 'Large-Scale Defect Rectification — Pelican Road, Schofields',
    location: 'Schofields, NSW',
    date: '2025',
    serviceType: 'Crack Injection, Waterproofing & Building Commissioner Compliance',
    serviceId: 'crack-injection',
    category: ['Residential', 'Structural', 'Compliance'],
    ...
    tagline: 'Five buildings, three basements, 3,000+ linear metres of cracking rectified under NSW Building Commissioner order',
    challenge: 'Following handover of five residential buildings at Pelican Road, Schofields, a significant range of defects were identified across the development. Cracking was observed across slab-on-ground and suspended basement slabs, with water ingress through shoring wall shotcrete affecting fire stair areas across three basement levels. Over 3,000 linear metres of cracking were identified, with structural cracking in suspended elements requiring engineer-approved repair methodologies. The NSW Building Commissioner\'s office had issued a formal rectification order requiring documented compliance. With all units occupied and all basement car parks in active daily use, access was tightly constrained — a staged, coordinated approach was essential.',
    solution: 'TRD Remedial developed a comprehensive repair methodology reviewed and approved by the structural engineer of record. The scope addressed every defect category across all five buildings and three basement levels, coordinated directly with the Building Commissioner\'s office. Delivered sequentially across two months, works were staged around active car parks and occupied areas. The full scope included epoxy injection for structural crack repairs in suspended slabs, crack injection and surface repairs across slab-on-ground areas, concrete spalling repairs, joint sealing, waterproofing repairs to shoring walls to arrest water ingress across three basement levels, and drainage repairs.',
    results: 'All defects were successfully rectified across all five buildings within the two-month staged program. The formal rectification order issued by the NSW Building Commissioner\'s office was fully answered and closed — preventing any risk of further regulatory escalation, which could have included evacuation orders affecting residents. Car parks remained accessible throughout, and residents experienced minimal disruption despite the scale of works. The development now meets full structural and waterproofing compliance requirements, and the risk of further deterioration has been eliminated.',
    stats: [
      { value: '3,000+', label: 'Linear Metres Repaired' },
      { value: '5', label: 'Buildings Rectified' },
      { value: '2mo', label: 'Staged Program' },
    ],
    galleryImages: [
      {
    ...
    timeline: '2 Months (staged, sequential)',
    relatedProjects: ['project-004', 'project-010'],
    metaTitle: 'Large-Scale Defect Rectification — Pelican Road, Schofields NSW | TRD Remedial',
    metaDescription: 'TRD Remedial rectified 3,000+ linear metres of cracking across five residential buildings and three basements at Schofields, closing a NSW Building Commissioner rectification order within two months.',
  },
  {
    id: 'project-008',
  ...
  },
  {
    ...
    name: 'One The Waterfront — Structural Alterations & Multi-Service Works',
    location: 'Wentworth Point, NSW',
    date: '2025',
    serviceType: 'Structural Alterations & Multi-Service',
    serviceId: 'structural-alterations',
    category: ['Commercial', 'Structural', 'Construction'],
    ...
    tagline: 'Expert structural reconfiguration of an abandoned development — 40 columns removed, 5,000 linear metres of cutting, 2,000 core holes in five weeks',
    challenge: 'When Masscon acquired the existing One The Waterfront development — a partially completed complex previously abandoned by another developer — they inherited a structural challenge of significant scale. Two buildings remained standing but the structure was not wholly sound. The vision for the new development demanded more levels, more units, and a complete reconfiguration of the structural layout. TRD Remedial was tasked with column removal, large slab penetrations for new stair cores and lift shafts, stormwater relining, and structural reinforcement — all within an extremely tight timeframe with neighbouring buildings fully occupied throughout.',
    solution: 'TRD Remedial delivered an exceptional scope: 2,000 core holes drilled for shoring, precision relief cores along slab penetration perimeters, and standalone penetrations. 5,000 linear metres of concrete cutting was executed through four suspended basement slabs and one slab-on-ground, creating penetrations for one new stair core running from Basement 4 to Ground Floor and two new lift shaft cores. 40 columns were removed with full propping and temporary works to maintain structural integrity. Formwork catch decks were erected to safely contain cut concrete prior to crane extraction. Full stormwater pipe relining was completed within the Basement 4 slab-on-ground.',
    results: 'Despite the enormous scope — structural alterations, column removals, slab cutting across five levels, precision core drilling, and drainage infrastructure — TRD Remedial completed the entire project in just five weeks, with no incidents, no delays, and no disruption to neighbouring occupied buildings. The development proceeded successfully. One The Waterfront stands as a testament to what is possible when expert planning, structural precision, and a highly skilled remedial team come together under pressure.',
    stats: [
      { value: '2,000', label: 'Core Holes Drilled' },
      { value: '5,000', label: 'Linear Metres Cut' },
      { value: '40', label: 'Columns Removed' },
    ],
    galleryImages: [
      {
        url: '/images/projects/florence-capri-complex/gallery-01.jpg',
        alt: 'Column removal with full propping at One The Waterfront development',
      },
      {
        url: '/images/projects/florence-capri-complex/gallery-02.jpg',
        alt: 'Precision core drilling for shoring and structural penetrations',
      },
      {
        url: '/images/projects/florence-capri-complex/gallery-03.jpg',
        alt: 'Concrete cutting through suspended basement slab for new lift shaft core',
      },
      {
        url: '/images/projects/florence-capri-complex/before-01.jpg',
        alt: 'Formwork catch decks erected to safely capture cut concrete sections',
      },
      {
        url: '/images/projects/florence-capri-complex/after-01.jpg',
        alt: 'New stair core penetration from Basement 4 to Ground Floor',
      },
      {
        url: '/images/projects/florence-capri-complex/featured.jpg',
        alt: 'Completed structural reconfiguration at One The Waterfront, Wentworth Point',
      },
      {
        url: '/images/projects/florence-capri-complex/thumbnail.jpg',
        alt: 'Aerial view of One The Waterfront development at Wentworth Point',
      },
    ],
    timeline: '5 Weeks',
    relatedProjects: ['project-005', 'project-008'],
    metaTitle: 'One The Waterfront — Structural Alterations & Multi-Service Works | TRD Remedial',
    metaDescription: 'TRD Remedial delivered 2,000 core holes, 5,000 linear metres of concrete cutting, and 40 column removals at One The Waterfront, Wentworth Point — completed in five weeks with zero incidents.',
  },
  {
    id: 'project-012',
    slug: 'zetland-surelock',
    name: 'SureLok™ Temporary Movement Joints — Zetland',
    location: 'Zetland, NSW',
    date: '2025',
    serviceType: 'Post-Tensioning & SureLok™ TMJ',
    serviceId: 'temporary-moving-joints',
    category: ['Commercial', 'Construction', 'Post-Tensioning'],
    ...
    tagline: 'World-first SureLok™ temporary movement joint system delivered as part of TRD Group\'s integrated post-tensioning scope',
    challenge: 'On a live construction site in Zetland, TRD Group — TRD Remedial\'s parent company — was engaged as the post-tensioning contractor for the development. As part of the broader post-tensioning scope, TRD managed the supply and installation of SureLok™ Temporary Movement Joints (TMJs), an engineered product system that eliminates the need for traditional pour strips and corbels during construction. Conventional pour strips require extended curing periods, complex formwork, and additional structural corbels — adding cost, complexity, and time to the construction program.',
    solution: 'SureLok™ is a patented, purpose-engineered temporary movement joint system — the first of its kind to provide bi-directional temporary movement and two-axis load transfer within a single, fully sealed component, a world-first in construction joint technology. It allows back-propping to be removed earlier (once concrete achieves 32MPa), simplifies the construction sequence, and delivers measurable improvements in both program duration and jobsite safety. TRD Group\'s integrated capability allowed seamless coordination of the SureLok™ works across slab-to-slab and slab-to-wall interfaces as part of the broader concrete program.',
    results: 'The SureLok™ installation eliminated pour strips entirely, reduced construction complexity, and accelerated the program. No corbels were required, simplifying structural detailing. Earlier back-prop removal improved construction sequencing across the site. The system delivered bi-directional movement and two-axis load transfer in a single sealed unit, with improved jobsite safety versus conventional TMJ methods. All works were delivered as part of TRD Group\'s integrated post-tensioning scope — providing a single point of accountability for the builder.',
    stats: [
      { value: 'World-First', label: 'TMJ Technology' },
      { value: '0', label: 'Pour Strips Required' },
      { value: '32MPa', label: 'Early Back-Prop Removal' },
    ],
    galleryImages: [
      {
    ...
    timeline: 'Part of broader post-tensioning scope',
    relatedProjects: ['project-003', 'project-009'],
    metaTitle: 'SureLok™ Temporary Movement Joints — Zetland NSW | TRD Remedial',
    metaDescription: 'TRD Group delivered SureLok™ TMJ installation at Zetland as part of an integrated post-tensioning scope, eliminating pour strips and corbels with world-first bi-directional movement joint technology.',
  },
];
