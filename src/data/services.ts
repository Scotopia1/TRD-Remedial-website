...
export const SERVICES: Service[] = [
  {
    ...
    icon: '/images/services/structural-strengthening/feature.jpg',
    visual: '/images/services/structural-strengthening/hero.jpg',
    heroImage: '/images/services/structural-strengthening/hero.jpg',
    featureImage: '/images/services/structural-strengthening/feature.jpg',
    processImage: '/images/services/structural-strengthening/process.jpg',
    stats: [
    ...
    faqs: [
      ...
      {
        question: 'Is structural strengthening permanent?',
      ...
      {
        question: 'How much does structural strengthening cost?',
      ...
      },
      {
        ...
        answer: 'Yes, structural strengthening is minimally disruptive. Surface preparation creates dust managed with containment barriers, and CFRP application uses low-odor epoxies. Most work can proceed with building occupancy using temporary surface protection and scheduling during non-critical hours. No load removal required in many cases.',
      },
      {
  ...
  },
  {
    ...
    icon: '/images/services/structural-alterations/feature.jpg',
    visual: '/images/services/structural-alterations/hero.jpg',
    ...
    relatedServices: ['concrete-cutting', 'structural-strengthening', 'curtain-wall-injection'],
    faqs: [
      {
  ...
  },
  {
    ...
    visual: '/images/services/crack-injection/feature.jpg',
    heroImage: '/images/services/crack-injection/feature.jpg',
    featureImage: '/images/services/crack-injection/hero.jpg',
    ...
    relatedServices: ['structural-strengthening', 'structural-alterations', 'slab-scanning'],
    faqs: [
      {
  ...
  },
  {
    ...
    icon: '/images/services/concrete-cutting/feature.jpg',
    visual: '/images/services/concrete-cutting/hero.jpg',
  ...
  },
  {
    ...
    relatedServices: ['crack-injection', 'structural-strengthening', 'structural-alterations'],
    faqs: [
      {
        question: 'How long does concrete repair take?',
        answer: 'Most concrete repair projects are completed in 1-3 days depending on the extent of damage and surface area. Residential driveway or patio repairs typically take 1-2 days, while large commercial facade repairs may take 3-5 days. The application itself is quick, but proper surface preparation and curing time are essential for long-lasting results.',
      },
      {
        question: 'Is concrete repair a permanent solution?',
        answer: 'Yes, when completed with quality polymer-modified repair mortars and proper surface preparation, concrete repairs are permanent and carry warranties of 2-5 years depending on application. The repair mortar is designed to match the concrete\'s strength and flexibility, preventing recurrence of the same crack.',
      },
      {
      ...
      {
        question: 'Can concrete repairs be done in occupied buildings?',
        answer: 'Absolutely. Concrete repair is minimally disruptive with low dust generation and odor when using low-VOC polymer mortars. Residential and commercial properties can remain occupied during repairs. We can schedule weekend or after-hours work to minimize disruption to business operations.',
      },
    ],
    testimonials: [
      {
  ...
  },
  {
    ...
    icon: '/images/services/slab-scanning/feature.jpg',
    visual: '/images/services/slab-scanning/hero.jpg',
  ...
  },
  {
    ...
    icon: '/images/services/curtain-wall-injection/feature.jpg',
    visual: '/images/services/curtain-wall-injection/hero.jpg',
    ...
    relatedServices: ['crack-injection', 'structural-alterations', 'concrete-repairs'],
    faqs: [
      {
  ...
  },
  {
    ...
    icon: '/images/services/temporary-moving-joints/feature.jpg',
    visual: '/images/services/temporary-moving-joints/hero.jpg',
  ...
  {
    id: 'post-tension-truncation',
    slug: 'post-tension-truncation',
    title: 'Post Tension Truncation',
    tagline: 'Precision cable identification and safe truncation',
    ...
    features: [
      ...
      'Safe cable de-tensioning',
      'Concrete restoration',
      'Compliance documentation',
    ],
    benefits: [
      'Non-destructive cable detection',
      'Zero structural compromise',
      'Full compliance documentation',
      'Minimal site disruption',
    ],
    icon: '/images/services/post-tension-truncation/feature.jpg',
    visual: '/images/services/post-tension-truncation/hero.jpg',
    heroImage: '/images/services/post-tension-truncation/hero.jpg',
    featureImage: '/images/services/post-tension-truncation/feature.jpg',
    processImage: '/images/services/post-tension-truncation/process.jpg',
    stats: [
      { value: '100+', label: 'Cables Truncated' },
      { value: '0', label: 'Structural Incidents' },
      { value: '100%', label: 'Compliance Rate' },
    ],
    process: [
      { step: 1, title: 'GPR Scanning', description: 'Advanced ground-penetrating radar survey to map all post-tension cables, rebar, and conduits within the slab.' },
      { step: 2, title: 'Cable Identification', description: 'Precise marking and documentation of cable locations, stress levels, and truncation points.' },
      { step: 3, title: 'Safe De-tensioning', description: 'Controlled release of cable tension using specialized equipment to prevent structural shock.' },
      { step: 4, title: 'Precision Truncation', description: 'Clean cable cutting at designated points with minimal concrete disturbance.' },
      { step: 5, title: 'Concrete Restoration', description: 'Professional grouting and restoration of truncation pockets to restore slab integrity.' },
    ],
    relatedProjects: ['project-006'],
    commonApplications: 'Post-tension truncation is essential for residential renovations, commercial fit-outs, structural modifications, and compliance rectification in post-tensioned buildings. Common applications include creating new openings in post-tensioned slabs, modifying load paths, and addressing building compliance requirements.',
    whyChooseTRD: 'TRD Remedial combines advanced GPR scanning technology with decades of structural engineering expertise to deliver safe, precise post-tension truncation. Our zero-incident track record and full compliance documentation give property owners and builders confidence in every project.',
    ...
    relatedServices: ['slab-scanning', 'concrete-cutting', 'structural-alterations'],
    faqs: [
      {
        question: 'What is post-tension truncation?',
        answer: 'Post-tension truncation is the controlled process of identifying, de-tensioning, and cutting post-tension cables within concrete slabs. This is required when structural modifications need to be made to post-tensioned buildings, such as creating new openings or modifying load paths.',
      },
      {
        question: 'Is post-tension truncation safe?',
        answer: 'When performed by experienced professionals using GPR scanning and controlled de-tensioning procedures, post-tension truncation is completely safe. TRD Remedial has a zero-incident track record across all truncation projects.',
      },
      {
        question: 'How long does post-tension truncation take?',
        answer: 'The timeline depends on the number of cables and complexity of the project. A typical residential truncation project takes 2-5 days, including scanning, truncation, and concrete restoration.',
      },
    ],
    testimonials: [
      {
