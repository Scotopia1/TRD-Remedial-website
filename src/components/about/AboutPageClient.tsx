...
/* ================================================================
   ABOUT PAGE CLIENT -- BLACK BOX
   Declassified Technical Dossier (Client Shell)
   ================================================================ */
export function AboutPageClient({
  ...
  const siteDisplayUrl = SITE_URL.replace(/^https?:\/\//, '');
  ...
  return (
    <div className="bb-page" ref={pageRef}>
      ...
      <section className="bb-mission" id="bb-mission" aria-label="Mission">
        <div className="bb-doc-frame">
          ...
          <p className="bb-mission-body">
            {companyDescription ?? "TRD Remedial is Sydney\u2019s trusted partner for structural remediation and concrete repair. With decades of combined experience, we specialize in post-tension repairs, carbon fibre reinforcement, and advanced diagnostic services that keep buildings safe and structurally sound."}
          </p>
          ...
          <RedactionReveal delay={0.2}>
            <p className="bb-hidden-quote">
              {companyQuote
                ? `\u201c${companyQuote}\u201d`
                : <>&ldquo;When the scope is complex, the timeline is tight, and the margin for error is zero &mdash; we deliver.&rdquo;</>
              }
            </p>
          </RedactionReveal>
      ...
      <section className="bb-stats" id="bb-data" aria-label="Operational Statistics">
        <StatsReadout stats={stats} dataStream={dataStream} />
      </section>
      ...
      <section className="bb-directives-section" id="bb-directives" aria-label="Core Directives">
        <CoreDirectives values={companyValues} establishedYear={establishedYear} />
      </section>
        ...
        <div className="bb-cta-content">
          ...
          <div className="bb-cta-contact">
            <div className="bb-cta-contact-line">
              ...
              <a href={`mailto:${settings.contactEmail ?? 'contact@trdremedial.com.au'}`}>
                {settings.contactEmail ?? 'contact@trdremedial.com.au'}
              </a>
            </div>
            <div className="bb-cta-contact-line">
              <span className="bb-cta-contact-prefix">&gt; </span>
            ...
            <div className="bb-cta-contact-line">
              <span className="bb-cta-contact-prefix">&gt; </span>
              {settings.contactAddress ?? 'Sydney, NSW, Australia'}
            </div>
          </div>
